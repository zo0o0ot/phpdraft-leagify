...
$app->post('/commish/draft/{draft_id}/pick/{player_id}', "commish.pick.controller:Add")->before($commishEditableDraft)->before($draftInProgress);
...
$app->put('/commish/draft/{draft_id}/pick/{player_id}', "commish.pick.controller:Update")->before($commishEditableDraft)->before($draftInProgress);
