...
$configuration_variables = array(
  ...
  'DB_NAME' => getenv('LEAGIFY_MYSQL_DBNAME'),
  'DB_PORT' => getenv('LEAGIFY_MYSQL_DBPORT'),
  'DB_USER' => getenv('LEAGIFY_MYSQL_USER'),
  'DB_PASS' => getenv('LEAGIFY_MYSQL_PASS'),
  ...
  'AUTH_KEY' => getenv('LEAGIFY_AUTH_KEY'),
  ...
  'RECAPTCHA_SECRET' => getenv('LEAGIFY_RECAPTCHA_SECRET'),
  ...
  'MAIL_SERVER' => getenv('LEAGIFY_MAIL_SERVER'),
  'MAIL_USER' => getenv('LEAGIFY_MAIL_USER'),
  'MAIL_PASS' => getenv('LEAGIFY_MAIL_PASS'),
  'MAIL_PORT' => getenv('LEAGIFY_MAIL_PORT'),
  ...
  'APP_BASE_URL' => 'https://leagify.me',
  //Provide the base URL for the API (no trailing slash):
  'API_BASE_URL' => 'https://leagify.me/api',
